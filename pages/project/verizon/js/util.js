...
function processLongName( longname, limit ) {
	if(longname.length > limit ){
		...
		var width = limit*7;
		temp_name += "...";
		temp_name = "<image src=\"/_images/connectionstatus_footer_bg.png\" style=\"position:absolute;z-index:0;opacity:0;height:20px;width:"+width+"px;filter:alpha(opacity=0);\" alt=\""+longname+"\">"+temp_name;
		return temp_name;
	}
	else {
		return longname;
