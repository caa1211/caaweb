    ...
    $.fn.VDcomponent = function(settings){
        ...
        var removePortCls = function(portObj, speed){
            ...
            $.each(portDef[index].status, function(i, d){
               ...
               /* $portObj.animate({
                        ...
                        if (d.cls != undefined) {
                            $(this).css('visibility', 'hidden').removeClass(d.cls);
                        }
                    });*/
                   // alert('remove  '+d.cls)
                    //if
        ...
        var changePortStatus = function(obj, cls, title){
            ...
            if (!obj.hasClass(cls)) {
                ...
                obj.addClass(cls).css('visibility', 'visible');
        ...
        this.setValue = function(data){
            ...
            $.each(data, function(i, date){
                ...
                if (portDef[i].status[data[i].status] == '') {
                    ...
                    portCls = portDef[i].status[data[i].status].cls==undefined ? '' : portDef[i].status[data[i].status].cls;
