...
(function(jQuery){
    jQuery.fn.checkTree = function(settings){
        ...
        .find("ul").hide().end()        // Hide all checkbox inputs
        .find(":checkbox").change(function(){
            ...
            if ($all.length == $checked.length) {
                ...
                jQuery(this).attr("checked", "").siblings(".checkbox").removeClass("checked").addClass("half_checked");
            }
        }).attr("checked", "").hide().end().find("label")        // Clicking the labels should expand the children
        .click(function(){
        ...
        .hover(function(){
            ...
            $checkbox.click(function(){
                ...
                jQuery(this)                // if it's half checked, its now either checked or unchecked
                .removeClass("half_checked").toggleClass("checked")                // Send a click event to the checkbox to toggle it as well
            ...
            jQuery(this).prepend($checkbox).prepend($arrow);
        });
